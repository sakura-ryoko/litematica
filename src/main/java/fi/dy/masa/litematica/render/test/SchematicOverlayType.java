...
public enum SchematicOverlayType
{
    ...
    SchematicOverlayType(VertexFormat.DrawMode drawMode, int bufferSize, VertexFormat format, boolean crumbling, boolean translucent)
    {
