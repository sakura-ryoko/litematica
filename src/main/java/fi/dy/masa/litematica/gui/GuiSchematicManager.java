			...
			if (this.type == Type.EDIT_SCHEMATIC)
			{
				if (fileType == FileType.LITEMATICA_SCHEMATIC)
				{
					...
					else if (this.gui.editType == EditType.CHANGE_AUTHOR)
					{
						...
						GuiBase.openGui(new GuiTextInputFeedback(128, "litematica.gui.title.schematic_change_author", oldName, this.gui, new SchematicChangeAuthor(entry.getDirectory(), entry.getName(), this.gui)));
					}
