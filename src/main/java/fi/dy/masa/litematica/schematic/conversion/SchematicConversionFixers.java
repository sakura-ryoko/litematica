    ...
    public static final IStateFixer FIXER_SIGN = (reader, state, pos) -> {
	        ...
	        (tag.contains("Text1") || tag.contains("Text2") || tag.contains("Text3") || tag.contains("Text4")))
        {
	        ...
	        try
	        {
		        ...
		        text1 = tag.contains("Text1") ? Text.Serialization.fromJson(tag.getString("Text1", ""), registry) : Text.empty();
		        text2 = tag.contains("Text2") ? Text.Serialization.fromJson(tag.getString("Text2", ""), registry) : Text.empty();
		        text3 = tag.contains("Text3") ? Text.Serialization.fromJson(tag.getString("Text3", ""), registry) : Text.empty();
		        text4 = tag.contains("Text4") ? Text.Serialization.fromJson(tag.getString("Text4", ""), registry) : Text.empty();
	        }
