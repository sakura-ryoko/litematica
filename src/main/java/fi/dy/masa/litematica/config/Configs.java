...
public class Configs implements IConfigHandler
{
    ...
    public static class Generic
    {
        ...
        public static final ConfigInteger       COMMAND_LIMIT               = new ConfigInteger("commandLimitPerTick", 8, 1, 256, "litematica.config.generic.comment.commandLimitPerTick").translatedName("litematica.config.generic.name.commandLimitPerTick");
        ...
        public static final ConfigDouble        ENTITY_DATA_SYNC_CACHE_TIMEOUT= new ConfigDouble("entityDataSyncCacheTimeout", 2.0f, 0.25f, 30.0f, "litematica.config.generic.comment.entityDataSyncCacheTimeout").translatedName("litematica.config.generic.name.entityDataSyncCacheTimeout");
