...
public class Hotkeys
{
    ...
    public static final ConfigHotkey SCHEMATIC_PLACEMENT_ROTATION       = new ConfigHotkey("schematicPlacementRotation",        "LEFT_CONTROL,R",     KeybindSettings.MODIFIER_INGAME, "litematica.config.hotkeys.comment.schematicPlacementRotation").translatedName("litematica.config.hotkeys.name.schematicPlacementRotation");
    public static final ConfigHotkey SCHEMATIC_PLACEMENT_MIRROR         = new ConfigHotkey("schematicPlacementMirror",          "LEFT_CONTROL,F",     KeybindSettings.MODIFIER_INGAME, "litematica.config.hotkeys.comment.schematicPlacementMirror").translatedName("litematica.config.hotkeys.name.schematicPlacementMirror");
