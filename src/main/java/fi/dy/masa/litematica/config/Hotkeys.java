...
public class Hotkeys
{
    ...
    public static final ConfigHotkey RENDER_INFO_OVERLAY                = new ConfigHotkey("renderInfoOverlay",                 "I",            KeybindSettings.PRESS_ALLOWEXTRA_EMPTY, "litematica.config.hotkeys.comment.renderInfoOverlay").translatedName("litematica.config.hotkeys.name.renderInfoOverlay");
